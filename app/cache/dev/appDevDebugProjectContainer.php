...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/symfony2/src/Acceso/loginBundle/Entity')), 'Acceso\\loginBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AccesologinBundle' => 'Acceso\\loginBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/symfony2/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/symfony2/src/Acceso/loginBundle/Resources/views', 'Accesologin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AccesologinBundle' => 'Acceso\\loginBundle\\AccesologinBundle',
